...
function mytheme_admin()
{
    ...
    if ($_REQUEST['saved'])
        echo '<div id="message" class="updated fade"><p><strong>' . $themename . ' 设置已保存。</strong></p></div>';
    if ($_REQUEST['reset'])
        echo '<div id="message" class="updated fade"><p><strong>' . $themename . ' 已经回复默认设置。</strong></p></div>';
...
?> 
            <tr>
            <td width="15%" rowspan="2" valign="middle"><strong><?php
                echo $value['name'];
?></strong></td>
            <td width="85%"><textarea name="<?php
                echo $value['id'];
...
?>
            ...
            <td width="15%" rowspan="2" valign="middle"><strong><?php
                echo $value['name'];
?></strong></td>
            <td width="85%"><select style="width:50px;" name="<?php
                echo $value['id'];
?>" id="<?php
                echo $value['id'];
?>"><?php
